				...
				<div className="col-12 ma0-l">
					...
					<div className="card card-primary">
						...
						<div className="card-body">
							...
							<p>Вопрос: как закрывать онлайн оплату? <br />
								Ответ: Как и любой другой заказ</p>
							<p>Вопрос: Когда мы отменяем заказ, мы делаем отмену покупки или возврат денежных средств. Вопрос о времени возврата дс <br />
								Ответ: Когда вы хотите сделать, возврат вам нужно зайти в админ панель, в заказ и нажать отмена и гостю сразу вернутся деньги, отмена заказа в айко на платеж не влияет</p>

							<p>Вопрос: Добавление новых позиций в заказ или когда гость передумает <br />
								...
								изменение суммы оплаты на данный момент нету</p>

							<p>Вопрос: гость не смог оплатить <br />
								Ответ: если у человека не получилось оплатить, вы можете дальше работать с его заказом</p>

							<p>Вопрос: Подскажите, а как нам брать дополнительную оплату за доставку, после того как заказ оплачен и есть дальние расстояния, где сумма доставки увеличивается? <br />
								...
								в любом случае, если гостю нужно вернуть деньги, нажимайте "отмена" в админ панели, если у вас вызывает сомнения или возник вопрос, тегайте нас, мы поможем</p>

							<p>Вопрос: Заявку оставили, а оплата почему то не проходит <br />
								Ответ: Возможно заказ в обработке или человек долго думает по факту ему на оплату дают до 5мин, вы можете сами выбрать лимит ожидания оплаты, после чего звонить гостю</p>

							<p>Вопрос: что нужно сделать что бы деньги поступили на счет <br />
								Ответ: в конце смены, вам нужно нажать "подтвердить" в админ панели, что бы деньги поступили вам на счет, как описано в справочнике</p>
