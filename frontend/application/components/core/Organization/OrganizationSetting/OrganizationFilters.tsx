	...
	return (
		...
		<div className="card card-primary">
			...
			<div className="card-body">
				...
				{modalEdit &&
					<div className="modal_box">
						<div className="modal_overfloy" onClick={() => setModalEdit(false)}></div>
						<div className="col-md-8 modales">
							<div className="card card-warning">
								<div className="card-header">
									<h3 className="card-title">Добавить фильтр</h3>
									...
									<div className="card-tools">
										<button type="button" className="btn btn-tool" data-card-widget="remove" onClick={() => setModalEdit(false)}>
											<img src="/img/close.png" />
											...
											<div className='col-md-12'>
												<div className='card card-primary'>
													...
													<div className='card-body'>
														<div className="popBox_item form-group">
															<label className="form-label">Название</label>
															<input type="text" {...register('name')} name="name" defaultValue={modalEdit.name} className="form-control" />
														</div>
														<div className='popBox_item'>
															<label className='form-label'>фото в организации</label>
															<DropzoneArea onChange={e => setFile(e)} filesLimit={1} initialFiles={imagesArr(modalEdit.images)}
...

								{
									...
									filters.map((val: any) => {
										...
										return <><button key={val._id} onClick={async () => {
											...
											<img width="24" height="24" src="/img/seting.png" onClick={() => setModalEdit(val)} />
										</>
									})
								}
							</div>
