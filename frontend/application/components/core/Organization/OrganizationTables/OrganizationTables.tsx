													...
													.map((val: any) => {
														return (
															...
															<li key={val.id} className="nav-item"> <strong>столик - №{val.number},</strong> <br />
																...
																{
																	`https://хинкалыч.рф/shop?organuzation=${organization.id}&table=${JSON.stringify({ id: val.id, numb: val.number, section: organizationTable[tableModal.tableindex].idsection })}&delivMetod=ONSPOT
													`}
															</li>
