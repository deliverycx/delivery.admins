														...
														
										{
											...
											.map((val: any) => {
												return (
													...
													{
														`https://с.хинкалыч.рф/shop?organuzation=${organization.id}&table=${JSON.stringify({id:val.id,numb:val.number,section:organizationTable[tableModal.tableindex].idsection})}&delivMetod=ONSPOT
													`} 
													</li>
