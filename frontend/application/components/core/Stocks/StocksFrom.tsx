					...
					<div className="col-md-12">
						<div className="card card-primary">
							...
							<div className="card-body">
								...
								<div className="form-group">
									{
										!slideId && <DropzoneArea onChange={e => setfile(e)} filesLimit={1} maxFileSize={300000000} />
									}

									{
										slideId && newslist && <DropzoneArea onChange={e => setfile(e)} filesLimit={1} maxFileSize={300000000} initialFiles={imagesArr(newslist.images)} />
									}
