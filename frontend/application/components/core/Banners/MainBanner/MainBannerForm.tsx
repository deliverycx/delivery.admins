							...
							<div className='card-body'>
								...
								<div className='popBox_item'>
									...
									<div className='form-group'>
										{
											!slideId && <DropzoneArea onChange={e => handlerFile('file', e)} filesLimit={1} maxFileSize={300000000} />
										}

										{
											slideId && stateBanners.banners &&
											<DropzoneArea onChange={e => handlerFile('file', e)} filesLimit={20}
												initialFiles={imagesArr(stateBanners.banners.images)} maxFileSize={300000000} />
										}
									</div>
								</div>
								<br />
								<div className='popBox_item'>
									...
									<div className='form-group'>
										{
											!slideId && <DropzoneArea onChange={e => handlerFile('smallfile', e)} filesLimit={1} maxFileSize={300000000} />
										}

										{
											slideId && stateBanners.banners &&
											<DropzoneArea onChange={e => handlerFile('smallfile', e)} filesLimit={1} maxFileSize={300000000}
								...
								<div className='popBox_item'>
									...
									<div className='form-group'>
										{
											!slideId && <DropzoneArea onChange={e => handlerFile('mobfile', e)} filesLimit={1} maxFileSize={300000000} />
										}
										{
											slideId && stateBanners.banners &&
											<DropzoneArea onChange={e => handlerFile('mobfile', e)} filesLimit={1} maxFileSize={300000000}
								...
								<div className='popBox_item'>
									...
									<div className='form-group'>
										{
											!slideId && <DropzoneArea onChange={e => handlerFile('stories', e)} maxFileSize={300000000} />
										}
										{
											slideId && stateBanners.banners &&
											<DropzoneArea onChange={e => handlerFile('stories', e)} filesLimit={6} maxFileSize={300000000}
